...
if st.button("Confirm"):
    ...
    ai_response = chat_with_ai(f"From the following conversation history, extract Name, Date, Time, and Number of tickets and return it as a Python list named info:\n\n{chat_history_text}")
    st.write("AI:", ai_response)
